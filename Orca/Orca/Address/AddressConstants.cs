...
namespace Orca.Address
{
    ...
    public static class AddressConstants
    {
        ...
        /// </summary>
        public static readonly string SYSTEM_PROGRAM_ID = Solnet.Programs.SystemProgram.ProgramIdKey;
        
        /// <summary>
        /// Solana token program. 
        /// </summary>
        public static readonly string TOKEN_PROGRAM_ID = Solnet.Programs.TokenProgram.ProgramIdKey;

        /// <summary>
        /// Associated Token Program public key. 
        /// </summary>
        public static readonly string ASSOCIATED_TOKEN_PROGRAM_ID = Solnet.Programs.AssociatedTokenAccountProgram.ProgramIdKey;
        ...
        public static readonly string RENT = Solnet.Programs.SysVars.RentKey;
