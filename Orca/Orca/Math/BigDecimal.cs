...
using InnerDecimal = Orca.Math.SpecialTypes.BigDecimal;
...
namespace Orca.Math
{
        ...
        , IComparable<float>
    {
        ...
        public BigDecimal Divide(BigDecimal divisor)
        {
            ...
            return new BigDecimal(InnerDecimal.Divide(_value, divisor._value));
        }
        ...
        public BigDecimal Divide(int divisor)
        {
            ...
            return new BigDecimal(InnerDecimal.Divide(_value, divisor));
        }

        public BigDecimal Divide(BigInteger divisor)
        {
        ...
        public BigDecimal Divide(decimal divisor)
        {
            ...
            return new BigDecimal(InnerDecimal.Divide(_value, (InnerDecimal)divisor));
        }
